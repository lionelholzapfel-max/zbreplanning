...
export type TournamentPredictionType = 'winner' | 'best_player' | 'best_young' | 'surprise_team';

const VALID_TYPES: TournamentPredictionType[] = ['winner', 'best_player', 'best_young', 'surprise_team'];
